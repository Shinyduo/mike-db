-- Mike application schema (runs after Supabase auth schema is initialized)
...
create table if not exists public.document_versions (
  ...
  constraint document_versions_source_check
    check (source = any (array['upload','user_upload','assistant_edit','user_accept','user_reject','generated']))
);
